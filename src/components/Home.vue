        ...
        <b-row>
          <b-col md="6">
            <b-media no-body class="py-3">
              <div class="icon mr-4" style="background-color: #72c02c"><i class="fa fa-folder-open-o font-lg"></i></div>
              <b-media-body>
                <div class="hdr">
            ...
            <b-media no-body class="py-3">
              <div class="icon mr-4" style="background-color: #9c8061"><i class="fa fa-lightbulb-o font-lg"></i></div>
              <b-media-body>
                <div class="hdr">
            ...
            <b-media no-body class="py-3">
              <div class="icon mr-4" style="background-color: #00bed6"><i class="fa fa-graduation-cap font-lg"></i>
              </div>
              <b-media-body>
                <div class="hdr">
          ...
          <b-col md="6">
            <b-media no-body class="py-3">
              <div class="icon mr-4" style="background-color: #585f69"><i class="fa fa-sort-alpha-asc font-lg"></i>
              </div>
              <b-media-body>
                <div class="hdr">
                  Английский язык
            ...
            <b-media no-body class="py-3">
              <div class="icon mr-4" style="background-color: #e64b3b"><i class="fa fa-code-fork font-lg"></i></div>
              <b-media-body>
                <div class="hdr">
                  Отдельные предметы
                </div>
            ...
            <b-media no-body class="py-3">
              <div class="icon mr-4" style="background-color: #e81c62"><i class="fa fa-book font-lg"></i></div>
              <b-media-body>
                <div class="hdr">
                  Книжный клуб
                </div>
            ...
            <b-media no-body class="py-3">
              <div class="icon mr-4" style="background-color: #18ba9b"><i class="fa fa-android font-lg"></i></div>
              <b-media-body>
                <div class="hdr">
                  Робототехника
                </div>
